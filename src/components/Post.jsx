...
const Post = () => {
  ...
  return (
    <div className='theme-bg flex flex-col gap-5 p-2'>
        ...
        <div className='w-full relative' onDoubleClick={doubleClick}>
            <img className='w-full h-full max-h-[700px] object-cover object-center' src="https://media.sproutsocial.com/uploads/2022/06/profile-picture.jpeg" alt="post" />
